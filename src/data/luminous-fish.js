...
const luminousHabitat = (spotIds, sizeScale = 1) => ({
...
const islandFish = ({
  ...
  habitats: [luminousHabitat(spots, sizeScale)]
});
...
export const LUMINOUS_ARCHIPELAGO_FISH = [
  ...
  islandFish({
    ...
    rarity: "uncommon", bodyClass: "standard", spots: ["warm_current_channel"], times: ["day","dusk"], weather: "any", baits: ["shrimp"], behavior: "sway",
  ...
  islandFish({
    ...
    rarity: "uncommon", bodyClass: "large", spots: ["warm_current_channel"], times: ["day"], weather: "sunny", baits: ["shrimp","bread"], behavior: "endurance",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "small", spots: ["windrest_shallows"], times: ["day","dusk"], weather: "any", baits: ["bread","shrimp"], behavior: "sprint",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "small", spots: ["windrest_shallows"], times: ["dusk","night"], weather: "any", baits: ["bread","cutfish"], behavior: "sprint",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "large", spots: ["windrest_shallows"], times: ["dawn","dusk"], weather: "any", baits: ["shrimp","worm"], behavior: "steady",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "small", spots: ["windrest_shallows"], times: ["dawn","day"], weather: "sunny", baits: ["shrimp","worm"], behavior: "sway",
  ...
  islandFish({
    ...
    rarity: "rare", bodyClass: "large", spots: ["windrest_shallows"], times: ["dawn","dusk"], weather: "any", baits: ["cutfish","glow"], behavior: "rare",
    ...
    tags: ["rare","large","sprint","tropical"], sizeScale: 1.05
  }),
  islandFish({
    id: "convict_surgeonfish", name: "條紋刺尾鯛", english: "Convict Surgeonfish", scientific: "Acanthurus triostegus",
    rarity: "common", bodyClass: "standard", spots: ["windrest_shallows"], times: ["dawn","day"], weather: "sunny", baits: ["bread","shrimp"], behavior: "sway",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "small", spots: ["prism_coral_garden"], times: ["dawn","day"], weather: "sunny", baits: ["bread","shrimp"], behavior: "steady",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "standard", spots: ["windrest_shallows"], times: ["day","dusk"], weather: "any", baits: ["shrimp","cutfish"], behavior: "steady",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "standard", spots: ["windrest_shallows"], times: ["dawn","dusk"], weather: "rain", baits: ["shrimp","worm"], behavior: "steady",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "standard", spots: ["windrest_shallows"], times: ["dawn","dusk"], weather: "any", baits: ["bread","cutfish"], behavior: "sprint",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "standard", spots: ["prism_coral_garden"], times: ["dawn","day"], weather: "any", baits: ["shrimp","worm"], behavior: "sway",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "standard", spots: ["warm_current_channel"], times: ["day","dusk"], weather: "any", baits: ["shrimp","cutfish"], behavior: "sway",
  ...
  islandFish({
    ...
    rarity: "common", bodyClass: "standard", spots: ["windrest_shallows"], times: ["day","dusk"], weather: "sunny", baits: ["bread","shrimp"], behavior: "sway",
  ...
  islandFish({
    ...
    rarity: "uncommon", bodyClass: "standard", spots: ["warm_current_channel"], times: ["day"], weather: "sunny", baits: ["shrimp","cutfish"], behavior: "endurance",
  ...
  islandFish({
    ...
    rarity: "uncommon", bodyClass: "large", spots: ["warm_current_channel"], times: ["dusk","night"], weather: "any", baits: ["shrimp","cutfish"], behavior: "sway",
  ...
  islandFish({
    ...
    tags: ["bottom","large","night","rain","tropical"]
  }),
  islandFish({
  ...
  islandFish({
    ...
    rarity: "uncommon", bodyClass: "large", spots: ["warm_current_channel"], times: ["day","dusk"], weather: "sunny", baits: ["shrimp","cutfish"], behavior: "endurance",
  ...
  islandFish({
    ...
    rarity: "uncommon", bodyClass: "large", spots: ["warm_current_channel"], times: ["dawn","day"], weather: "any", baits: ["shrimp","cutfish"], behavior: "steady",
  ...
  islandFish({
    ...
    tags: ["rare","large","sprint","tropical"], sizeScale: 1.04
  }),
  islandFish({
    id: "scrawled_filefish", name: "長尾革單棘魨", english: "Scrawled Filefish", scientific: "Aluterus scriptus",
    rarity: "rare", bodyClass: "large", spots: ["prism_coral_garden"], times: ["day","dusk"], weather: "rain", baits: ["cutfish","glow"], behavior: "rare",
    ...
    tags: ["rare","large","reef","rain","tropical"], sizeScale: 1.03
  })
];
