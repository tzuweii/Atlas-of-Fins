...
export {
  ...
  FISH_ASSET_PURPOSES, FISH_ASSET_REPRESENTATIVES, FISH_ASSET_SPEC, FISH_BODY_CLASSES, FISH_BODY_PLANS,
...
const fish = (id, name, english, rarity, spots, times, weather, baits, behavior, length, weight, price, difficulty, shape, colors, short, detail, fact, tags = []) => ({
  id, name, english, scientific: "灣區觀察紀錄", rarity, bodyClass: bodyClassFromTags(tags), spots, times, weather, baits, behavior,
...
export const BAY_EVENTS = [
  ...
  },
  {
    ...
    timeIds: ["dawn", "dusk"],
    fishIds: ["yellowtail_fusilier", "blacktip_fusilier", "bluespotted_cornetfish", "giant_trevally", "dogtooth_tuna"],
