...
根據《療癒釣魚養成遊戲｜初版開發規格書》製作的可玩瀏覽器遊戲，目前版本為 v0.5.0-alpha.2。v5 安全存檔、正規化事件、永久潮光與六艘船資料已完成；前三艘船可依 20／50 潮光門檻與固定金幣價格購買、在港口切換，並以 1.00／1.06／1.12 倍溫和航速鎖定每段航程。後三艘目前只留下名稱、輪廓與未來門檻，不會提前販售。
