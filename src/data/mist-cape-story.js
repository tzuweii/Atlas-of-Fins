...
export const MIST_CAPE_STORY_SCENES = [
  ...
  },
  {
    ...
    opening: [
      ...
      { speaker: "旁白", text: "剖面圖仍有零散空格。三十四種在地魚至少要確認二十四種，才能避免只用醒目的大型訪客替整片海下結論。" },
      { speaker: "霧禾", text: "完成霧岬七成魚類的主研究吧。二十四種已足夠讓雙流剖面可靠，其餘十種可以在往後自由往返時慢慢遇見。" },
      { speaker: "霧禾", text: "等研究冊亮起，再回到鐘下。我要把今天的剖面和港裡保存多年的季節頁疊在一起，看看這條寒流下一次會往哪裡擺。" }
    ],
    objective: {
      kind: "region-main-research",
      title: "完成霧岬寒流水道主研究",
      description: "親手發現 24／34 種霧岬魚類（七成，無須全收集），並完成前五節後回到霧禾身邊。",
      goal: 24,
