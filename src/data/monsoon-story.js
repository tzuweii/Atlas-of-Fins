...
export const MONSOON_STORY_SCENES = [
  ...
  },
  {
    ...
    opening: [
      ...
      { speaker: "季岑", text: "我們已完成前五節五之五。接著要讓三十六種在地魚裡至少二十六種出現在研究冊，才不會只用幾尾醒目魚替整個季風下結論。" },
      { speaker: "旁白", text: "研究冊明列二十六／三十六為七成主研究門檻。剩下十種與三十六／三十六完整收藏都保持自願，不影響航線。" },
      { speaker: "季岑", text: "達到前五節五／五與魚類探索二十六／三十六後，仍要回來正式交給我。只有我們一起把資料拓上風候石，下一張航線圖才會完成。" },
      { speaker: "季岑", text: "不用趕，也沒有失敗。等研究冊亮起再回港；石頭保存過很多季風，願意再替我們等一頁。" }
    ],
    objective: {
      kind: "region-main-research",
      title: "完成季風群島主研究並回港交付",
      description: "完成前五節 5／5，親手發現 26／36 種季風群島魚類（七成）；達標後回到季岑身邊正式完成。",
      goal: 26,
    ...
    completion: [
      ...
      { speaker: "旁白", text: "灰冠長浪航線在海圖上顯出輪廓，標記第五章「灰冠石岸」仍待測繪。你已正式取得航線拓印；在目的地開放前，三十六／三十六仍只是可自由完成的收藏。" },
