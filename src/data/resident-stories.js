...
export const RESIDENT_STORY_SCENES = [
  ...
  },
  {
    ...
    opening: [
      ...
      { speaker: "旁白", text: "她指向研究冊中尚未收束的空格。每個空格都對應一種在地魚與一段棲地關係；三十三種群島魚至少要確認二十四種，洋流邊緣才會顯出可相信的輪廓。" },
      { speaker: "澄野", text: "完成琉光群島七成魚類的主研究吧。不是要你抓盡所有東西，而是確認二十四種在地魚的生活位置，讓我們知道這張圖沒有只偏愛醒目的相遇。" },
      { speaker: "澄野", text: "等研究冊亮起最後一格，再回來找我。我會把浮標的路、你的捕獲與那兩次等待疊在一起，畫出真正能帶你往前走的線。" }
    ],
    objective: {
      kind: "region-main-research",
      title: "完成琉光群島主研究",
      description: "親手發現 24／33 種琉光群島魚類（七成，無須全收集），完成區域研究主路後回到澄野身邊。",
      goal: 24,
    ...
    completion: [
      { speaker: "旁白", text: "最後一筆資料被放回研究冊時，二十四種魚不再是分散的收藏。牠們沿著淺灘、礁影與深水重新排列，勾出一條穿過群島又向北延伸的暖流。" },
      { speaker: "澄野", text: "二十四種魚、兩次安靜的等待，還有一枚繞了半片海的舊浮標。剩下的魚仍能慢慢尋找，但七成資料已足夠讓我們相信這條路——不是因為拿走得多，而是因為彼此的關係沒有被漏掉。" },
